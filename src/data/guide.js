export const guidePages = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        html: `
          <ol class="timeline">
            <li><time>2026-06-22</time><p>1. 合并贡献者 PR：修复右侧目录高亮逻辑，并新增正文滚动时的目录追踪<br>2. 优化移动端触控尺寸、安全区和浏览器主题色<br>3. 将移动端目录抽屉调整为从右侧弹出<br>4. 使用 WebP 首页图并引入构建时图片优化，减少图片加载体积</p></li>
