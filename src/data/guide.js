export const guidePages = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        html: `
          <ol class="timeline">
            <li><time>2026-06-22</time><p>1. 修复右侧目录高亮逻辑，并新增正文滚动时的目录追踪<br>2. 优化移动端触控尺寸、安全区和浏览器主题色<br>3. 将移动端目录抽屉调整为从右侧弹出</p></li>
            ...
            <li><time>2026-06-14</time><p>1. 禁止普通文本复制，邮箱和新生群改为点击复制</p></li>
            <li><time>2026-06-14</time><p>1. 将原单页 HTML 重构为 Vue3 + Vite 文档站，并引入 Element Plus，统一页面组件与视觉样式<br>2. 改为文档式布局：顶部搜索、左侧目录、正文内容、右侧本文目录</p></li>
